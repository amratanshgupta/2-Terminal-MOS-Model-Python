...
class Capacitance_To_VGB(Total_charge_VGB_Surface_Potential):
    ...
    def Plot_C_vs_VGB(self):
        plt.semilogy(self.VGB_Cinv.keys(), self.Cinv, 'r', linestyle='--')
        plt.semilogy(self.VGB_Cdep.keys(), self.Cdep, 'g', linestyle='--')
        plt.semilogy(self.VGB_Csemiconductor.keys(), self.Csemiconductor, 'k', linestyle=':')
        plt.semilogy(self.VGB_Ctotal.keys(), self.Ctotal, 'b', linestyle='-.')
