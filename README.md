...
![Surface Potential vs Gate-Body Bias Plot](https://github.com/amratanshgupta/2-Terminal-MOS-Model-Python/blob/master/Surface_Potential_vs_Gate_Body_Bias.png)

**Option 2: Corresponds to Semiconductor Charge vs Surface Potential Plot
![Total SemiConductor Charge vs Surface Potential Plot](https://github.com/amratanshgupta/2-Terminal-MOS-Model-Python/blob/master/Total_SC_Charge_vs_Gate_Body_Bias.png)

**Option 3: Corresponds to Semiconductor Charge vs Gate Body Bias Plot
![Total SemiConductor Charge vs Gate Body Bias Plot](https://github.com/amratanshgupta/2-Terminal-MOS-Model-Python/blob/master/Total_SemiConductor_Charge_vs_Gate_Body_Bias.png)
